...
* Changing the replica factor `cassandra-stress write n=500000 no-warmup -node cassandra -schema "replication(strategy=SimpleStrategy, factor=2)" -mode native cql3 protocolVersion=3`
