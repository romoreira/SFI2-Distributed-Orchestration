...
X, y = SlidingWindow(5, stride=1, horizon=1, get_x=columns[:-1], get_y='target', seq_first=True)(df)
...
params = {'batch_size': 16, 'bidirectional': False, 'epochs': 100, 'hidden_size': 100, 'lr': 0.001, 'n_layers': 3, 'optimizer': SGD, 'patience': 10}
