...
from catboost import CatBoostRegressor  # Importando o CatBoost
...
catboost_model = CatBoostRegressor(
    iterations=500,  # Número de iterações (árvores)
    learning_rate=0.1,  # Taxa de aprendizado
    depth=6,  # Profundidade das árvores
    verbose=100  # Frequência dos logs
)
...
# Nome do arquivo CSV
csv_file = str(args.file_name).split('.')[0]+"_resultados_basic_algorithms-CatBoost-.csv"
